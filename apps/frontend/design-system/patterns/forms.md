...
```html
<div class="grid grid-cols-12 gap-6 py-5 border-b border-subtle">
...
<div class="flex flex-col gap-1.5">
  <label for="name"
         class="text-h6 uppercase tracking-wider text-text-secondary">
    Workflow name
...
<section class="space-y-6">
  <header>
    <h6 class="text-h6 uppercase tracking-wider text-text-secondary">
      Authentication
    </h6>
    <p class="mt-1 text-body-sm text-text-secondary max-w-prose">
...
```html
<footer class="sticky bottom-0 z-sticky -mx-6 px-6 py-4 mt-8
               bg-bg-canvas border-t border-subtle
...
<input aria-invalid="true" aria-describedby="email-error"
       class="input border-error
              focus:border-error focus:shadow-[0_0_0_3px_rgba(229,72,77,0.25)]" />
...
```html
<div role="alert" class="p-4 rounded-sm bg-error-surface border border-error/30
                          flex items-start gap-3 mb-6">
  <svg class="size-4 mt-0.5 text-error shrink-0">⚠</svg>
  <div>
    <p class="text-body-md font-semibold text-error">3 fields need attention</p>
    <ul class="mt-1 text-body-sm text-text-secondary list-disc list-inside">
