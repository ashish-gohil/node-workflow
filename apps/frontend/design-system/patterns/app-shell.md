...
```jsx
<div className="bg-bg-canvas text-text-primary flex h-screen flex-col">
  <div className="flex flex-1 overflow-hidden">
    {/* ICON RAIL */}
    <nav
      aria-label="Sections"
      className="bg-bg-canvas border-subtle flex w-14 shrink-0 flex-col items-center gap-1 border-r py-2"
    >
      {/* nav items */}
    </nav>
    ...
    {/* SIDEBAR */}
    <aside
      className="bg-bg-surface border-default flex w-[280px] shrink-0 flex-col border-r"
      data-state="expanded"
    >
      {/* logo + sub-nav */}
    </aside>
    ...
    <div className="flex min-w-0 flex-1 flex-col">
      <header className="border-subtle bg-bg-canvas flex h-14 shrink-0 items-center gap-4 border-b px-6">
        {/* breadcrumbs · search · actions */}
      </header>

      <main className="canvas-grid flex-1 overflow-auto">
        {/* canvas / page content */}
      </main>
    </div>
    ...
    <aside
      className="bg-bg-elevated border-default flex w-[480px] shrink-0 flex-col border-l"
      data-state="open"
      hidden
    >
      {/* drawer contents */}
