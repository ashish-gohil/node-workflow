...
<button className="bg-forest-500 hover:bg-forest-400 active:bg-forest-600 text-cream-50 duration-fast h-9 rounded-sm px-4 text-sm font-medium transition-colors">
  Run workflow
</button>;
```
