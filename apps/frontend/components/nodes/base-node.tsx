  ...
  return (
    <div
      className={cn(
        ...
        "transition-colors",
        "hover:ring-2 hover:ring-offset-1 hover:ring-offset-muted  hover:ring-border-strong group-hover:ring-2 group-hover:ring-border-strong hover:cursor-pointer",
        className
      )}
      tabIndex={0}
      {...props}
